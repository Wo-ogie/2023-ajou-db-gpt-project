...
import ajou.db.gpt.constant.user.RoleType;
...
public class JwtTokenProvider {
     ...
     */
    private JwtTokenInfoDto createJwtToken(String userId, RoleType roleType, Long tokenExpiredDuration) {
        Date now = new Date();
